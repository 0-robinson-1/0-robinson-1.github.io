  ...
  return (
    ...
    >
      <header className="app-header">
        <nav>
          <Link to="/">Home</Link> | <Link to="/blockchain">Blockchain</Link> | <a href="/docs/README-blockchain-app-v2.html" target="_blank" rel="noopener noreferrer">README</a> | <a href="/">Return to Main Site</a>
        </nav>
      </header>
